...
fn test_limb_rotation_chip_should_generate_24_bit_rotation_trace_correctly() {
    let input_number = 1u128;
    let expected_result_number = input_number << 24;
...
fn test_limb_rotation_chip_should_generate_16_bit_rotation_trace_correctly() {
    let input_number = 1u128;
    let expected_result_number = input_number << 16;
...
fn _test_limb_rotation_autogenerated<const N: usize>(input_number: u128, expected_result_number: u128) {
    let circuit =
        LimbRotationCircuitAutogenerated::<Fr, N>::new_for(value_for(input_number),
