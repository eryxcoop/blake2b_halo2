...
fn test_positive_rotate_right_63() {
    let circuit = Rotation63Circuit16bitLimbs::<Fr>::new_for_trace(valid_rotation_63_trace());
...
fn test_negative_rotate_right_63() {
    let mut invalid_rotation_trace = valid_rotation_63_trace();
...
fn valid_rotation_63_trace() -> [[Value<Fr>; 5]; 2] {
